...
<div class="main">
	...
	<main>
        ...
        <br>
        <button type="button" class="btn btn-info m-2" @click.prevent="startRecording()" v-bind:disabled="isStartRecording" id="btnStart">Start Recording</button>
        <button type="button" class="btn btn-success m-2" @click.prevent="submitVideo()" v-bind:disabled="isSaveDisabled" id="btnSave">{{ submitText }}</button>
        <button type="button" class="btn btn-primary m-2" @click.prevent="retakeVideo()" v-bind:disabled="isRetakeDisabled" id="btnRetake">Stop Recording</button>
    </div>
